...
4	Madlibs	Use Flask to localy run Madlibs Game	40
5	Shopping Cart	Incorporate HTML, CSS, Flask, Python to create a Shopping Cart	99
6	Intro to Bootstrap	Recreate a webpage using Bootstrap	25
\.
